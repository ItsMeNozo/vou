...
export function AddFriendPanel() {
  ...
  return (
    <div className="relative">
      <button
        className="p-2  hover:text-purple-700 transition-colors duration-300 rounded-full"
            ...
            <div>
              ...
              <div className="relative mb-4">
                <Input
                  ...
                  className="pr-10 border-purple-500"
                />
                {requestSent && (
                  <FontAwesomeIcon
                    icon={faCheck}
                    className="absolute inset-y-3 right-0 pr-3 flex items-center text-green-500"
                  />
                )}
              </div>
              <button
