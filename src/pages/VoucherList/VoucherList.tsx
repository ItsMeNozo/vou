							...
							<div className='p-1 bg-slate-50 flex'>
								<button
									className={`bg-white flex-1 p-2 border rounded-lg m-1 ${
										selectedTimeFrames[selectedGame] === 'Happening' ? 'border-[#7d4af9]  text-[#7d4af9]' : 'border-gray-500'
									}`}
								...
								<button
									className={`bg-white flex-1 p-2 border rounded-lg m-1 ${
										selectedTimeFrames[selectedGame] === 'Upcoming' ? 'border-[#7d4af9]  text-[#7d4af9]' : 'border-gray-500'
									}`}
