...
const QuizGameLanding: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center animate-bgcolor">
      <h1 className="font-raleway text-5xl text-white mb-10">Join a Game</h1>
      <form action="/quiz-game/player/" className="w-full max-w-md">
        <div className="mb-6">
          <label className="block text-center text-2xl font-raleway text-white mb-2">
            Display Name
          </label>
          <input
            id="name"
        ...
        <div className="mb-6">
          <button
            type="submit"
            className="w-full bg-gray-800 text-white py-4 rounded text-xl font-raleway"
          >
            Join
          </button>
        </div>
